...
namespace StoreFront.UI.MVC.Controllers
{
    ...
    public class CustomerDetailsController : Controller
    {
        ...
        public CustomerDetailsController(BeautySupplyContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.CustomerDetails != null ? 
                          ...
                          Problem("Entity set 'BeautySupplyContext.CustomerDetails'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'BeautySupplyContext.CustomerDetails'  is null.");
            }
            var customerDetail = await _context.CustomerDetails.FindAsync(id);
            if (customerDetail != null)
            {
